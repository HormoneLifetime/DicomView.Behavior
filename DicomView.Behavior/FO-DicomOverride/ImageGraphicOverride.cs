...
namespace DicomView.Behaviors
{
    ...
    /// </summary>
    public class ImageGraphicOverride : IGraphic
    {
        #region Protected Members

        protected IPixelDataOverride _originalData;

        protected IPixelDataOverride _scaledData;
        ...
        protected List<OverlayGraphicOverride> _overlays;
        ...
        /// </summary>
        public IPixelDataOverride OriginalData => _originalData;
        ...
        /// </summary>
        public IPixelDataOverride ScaledData
        {
            get
            {
                if (_scaledData == null)
                {
                    _scaledData = (_scaleFactor - 1.0).IsNearlyZero()
                        ? _originalData
                        : OriginalData.RescaleOverride(_scaleFactor);
                }
        ...
        /// <summary>
        /// Initialize new instance of <see cref="ImageGraphicOverride"/>
        /// </summary>
        /// <param name="pixelData">Pixel data</param>
        public ImageGraphicOverride(IPixelDataOverride pixelData)
            : this()
        {
        ...
        /// Default constructor
        /// </summary>
        protected ImageGraphicOverride()
        {
            _zorder = 255;
            _applyLut = true;
            _overlays = new List<OverlayGraphicOverride>();
        }
        ...
        public void AddOverlay(OverlayGraphicOverride overlay)
        {
        ...
        /// <inheritdoc />
        public unsafe void RenderImageOverride(int* pixels, ILUT lut)
        {
            ...
            foreach (var overlay in _overlays)
            {
                overlay.RenderOverride(pixels, ScaledWidth, ScaledHeight);
            }
        }
