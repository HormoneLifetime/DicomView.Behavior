...
{
    public sealed class WPFImageManagerOverride : IImageManager
    {

        public IImage CreateImage(int width, int height)
            => new WPFImageOverride(width, height);
    ...
    /// </summary>
    public sealed class WPFImageOverride : ImageBase<WriteableBitmap>
    {
        #region FIELDS
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="WPFImageOverride"/> object.
        /// </summary>
        /// <param name="width">Image width.</param>
        /// <param name="height">Image height.</param>
        public WPFImageOverride(int width, int height)
        ...
        private WPFImageOverride(int width, int height, PinnedIntArray pixels, WriteableBitmap image)
        ...
        public void Render(int[] pixels)
        {
            unsafe
            {
                ...
                try
                {
                    int* back = (int*)_image.BackBuffer;
                    var span = new Span<int>(back, pixels.Length);
